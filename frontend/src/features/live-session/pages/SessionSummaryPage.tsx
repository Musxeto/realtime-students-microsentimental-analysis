...
export function SessionSummaryPage() {
  ...
  return (
    <section className="admin-theme space-y-6 rounded-2xl border border-border/70 bg-gradient-to-br from-background via-card to-background/80 p-6 shadow-card panel-glow">
