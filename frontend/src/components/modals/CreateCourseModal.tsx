...
export function CreateCourseModal({ isOpen, onClose, teachers = [], onSubmit, isLoading }: CreateCourseModalProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setFormData({ course_name: '', course_code: '', semester: 1, section: 1, instructor_id: '' })
      onClose()
    } catch (err) {
  ...
  return (
    <BaseModal isOpen={isOpen} title="Create New Course" onClose={onClose} size="md">
