  ...
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-20 border-b border-border/80 bg-card/80 backdrop-blur-lg">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          <Link to="/" className="flex items-center gap-2 text-foreground">
            ...
            <span className="text-sm font-semibold tracking-wide">ClassPulse</span>
          </Link>
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/profile"
              className="rounded-lg border border-border p-1.5 text-foreground transition hover:bg-primary/10"
              title="Profile"
            >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[230px_1fr]">
        <aside className="panel-glow fade-in-up rounded-2xl border border-border/80 bg-card/90 p-3 shadow-card">
                ...
                className={({ isActive }) =>
                  [
                    ...
                    isActive
                      ...
                      : 'text-foreground/85 hover:bg-primary/10',
                  ].join(' ')
                }
              >
